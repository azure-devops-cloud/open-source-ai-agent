...
export default function AgentSettingsPage() {
  const { id } = useParams();
  const [form, setForm] = useState({ name: '', description: '', systemPrompt: DEFAULT_PROMPT, model: 'llama-3.3-70b-versatile', temperature: '0.2', tools: [], rssFeedUrls: '' });
  ...
  async function save(event) {
    ...
    const config = { systemPrompt: form.systemPrompt.trim(), model: form.model.trim(), temperature, tools: form.tools, rssFeedUrls };
